...
import { PrivacyContent } from "@/presentation/components/legal/LegalContent";
                        ...
                        <div>
                            ...
                            <div className="mt-8 pt-6 border-t border-[var(--cps-gray-light)] text-center">
                                ...
                                <Link 
                                    ...
                                    className="inline-block bg-[var(--cps-red-base)] hover:bg-[var(--cps-red-dark-10)] text-white px-6 py-2 rounded-[30px] transition-colors"
                                >
                                    Voltar ao Cadastro
                                </Link>
                            </div>
